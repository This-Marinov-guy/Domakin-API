...
class Property extends Model
{
    ...
    public static function rules($request = null): array
    {
        $rules = [
            ...
            'propertyData.furnished_type' => 'required|integer',
            'propertyData.shared_space'   => 'nullable|array',
            'propertyData.amenities'      => 'nullable|array',
            'propertyData.bathrooms'      => 'required|integer',
            'propertyData.toilets'        => 'required|integer',
            'propertyData.available_from' => 'required|date',
            'propertyData.available_to'   => 'nullable|date|after_or_equal:available_from',
            'propertyData.bills' => 'required|integer|min:0',
            'propertyData.deposit'        => 'required|integer|min:0',
            'propertyData.flatmates' => 'required|string',
            'propertyData.registration' => 'required|boolean',
            'propertyData.description' => 'required|string',
            'images' => 'required_without:newImages|nullable|string',
            'newImages' => 'required_without:images|nullable|array',
            'newImages.*' => 'file|image|mimes:jpeg,png,jpg,gif,webp,heic,heif,mp4,mov,avi,wmv,flv,mkv,webm,gif|max:5120',
